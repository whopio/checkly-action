...
* Alert settings.
*/
export class CheckAlertSettings {
    /**
    * Determines what type of escalation to use.
    */
    'escalationType'?: CheckAlertSettings.EscalationTypeEnum = CheckAlertSettings.EscalationTypeEnum.RunBased;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        {
            ...
            "type": "CheckAlertSettings.EscalationTypeEnum"
        },
        {
    ...
    static getAttributeTypeMap() {
        return CheckAlertSettings.attributeTypeMap;
    }
}

export namespace CheckAlertSettings {
